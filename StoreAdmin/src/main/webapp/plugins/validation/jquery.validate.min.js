...
;jQuery.validator.setDefaults({
	errorClass: "invalid", // 指定错误提示的 css 类名.
	wrapper: "small", // 指定使用`small`标签将`errorElement`包起来.
	errorElement: "span", // 指定使用`i`标签标记错误提示.
	errorPlacement: function (error, element) {
		// 添加`text-danger`样式到错误元素上.
		error.addClass("text-danger").prepend("<i class='fa fa-fw fa-exclamation-circle'></i>");

		if (element.is(":radio") || element.is(":checkbox")) {
			element.closest("div").append(error.addClass("center-block"));
		} else {
