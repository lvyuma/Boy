		...
		<div class="col-sm-9" >
			...
			<div class="box box-widget">
				<div class="box-header with-border">
					数据总览
					<div class="box-tools"><span class="label label-info">当月</span></div>
				</div>
				<div class="box-body">
			...
			<div class="box box-widget">
				<div class="box-header with-border">
					...
					<%--<div class="iframe-box">--%>
						<%--<iframe name="myiframe" src="${basePath}/admin/goods/showHotGoodsList.do" width="100%" height="200px" frameborder="0"></iframe>--%>
					<%--</div>--%>
				</div>
				<%--<div class="box-body">--%>
					<%--<p>对不起，没有任何数据噢！<a href="#">创建提醒</a></p>--%>
					<%--<div class="iframe-box">--%>
						<%--<iframe name="myiframe" src="${basePath}/admin/goods/showHotGoodsList.do" width="100%" height="200px">--%>
